...
class PageTemplater {
    ...
    private function __construct() {
        ...
        if ( version_compare( floatval( get_bloginfo( 'version' ) ), '4.7', '<' ) ) {
            ...
            // Add a filter to the wp 4.7 version of wordpress and newer
            add_filter(
                'theme_page_templates', array( $this, 'add_new_template' ), 999
            );
        ...
        add_filter(
            'template_include', array( $this, 'view_project_template'), 99
        );
        ...
        $this->templates = array(
            ...
            'templates/projekty_template.php'       => 'Проекти Розвитку Шаблон',
            'templates/vakansiyi_template.php'      => 'Вакансії Шаблон',
